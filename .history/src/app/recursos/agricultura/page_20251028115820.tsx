...
// Asegúrese de que DirectBookingCTA.tsx está en su carpeta components/
...
// Reemplace esta URL con el enlace de su Horario de Citas de Google Calendar para AGRICULTURA
const GOOGLE_CALENDAR_URL = "SU_ENLACE_DE_CALENDAR_PARA_AGRICULTURA_AQUI"; 
// ----------------------------------------------------
    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <header className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
          Roadmap 2025: Dejar de Ver la Tecnología como Imposición y Usarla para Ahorrar Recursos.
        </h1>
