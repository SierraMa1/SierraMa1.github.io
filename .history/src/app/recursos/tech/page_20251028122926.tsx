    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <section className="mb-12">
        ...
        <ol className="list-decimal list-inside space-y-4 text-lg text-gray-700 pl-4 mt-4">
            ...
            <li>
                <strong>Implementación DevOps y Habilitación de Equipos:</strong> Configuración de flujos CI/CD para automatizar testing y despliegue, reduciendo el Time-to-Market.
            </li>
            <li>
