...
const TECH_CHECKLIST = [
  "Sus desarrolladores tardan más de 30 minutos en desplegar una nueva funcionalidad.",
  "El 50% del tiempo se dedica a arreglar bugs en lugar de crear valor.",
...
// Reemplace esta URL con el enlace de su Horario de Citas de Google Calendar para EMPRESAS TECH
