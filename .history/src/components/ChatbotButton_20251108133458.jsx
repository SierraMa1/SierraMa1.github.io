...
export default function ChatbotButton() {
  ...
  return (
    ...
    <Head>
      ...
      />
      <Script 
        src={isDevelopment ? `http://217.154.181.135:3000//assets/modules/channel-web/inject.js` : `https://electricfinder.es/botpress/assets/modules/channel-web/inject.js`}
        strategy="afterInteractive" 
      />
