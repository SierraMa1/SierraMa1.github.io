      ...
      >
        ...
        <SwiperSlide>
          <div className="flex h-full w-full flex-col items-center justify-center text-center text-white p-4 px-8 md:px-4">
            <h1 className="text-4xl md:text-6xl font-bold drop-shadow-lg"> Desarrollo Full Stack con la Mentalidad Analítica de un Estratega Empresarial. Automatizo Procesos, No solo Web. </h1>
