...
export default function ChatbotButton() {
  ...
  // IP y puerto de tu servidor Botpress
  const BOTPRESS_IP = process.env.NEXT_PUBLIC_BOTPRESS_IP || 'localhost';
  const BOTPRESS_PORT = process.env.NEXT_PUBLIC_BOTPRESS_PORT || '3000'; // Puerto de Botpress (NO de Next.js)
  
  // URL del servidor Botpress
