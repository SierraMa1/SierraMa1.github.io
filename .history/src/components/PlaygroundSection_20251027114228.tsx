'use client'; // Necesario porque usaré "hooks" de React (useState)

import React, { useState, FormEvent } from 'react';

// --- Defino el "mini-juguete": una To-Do List ---
// Este es un componente autocontenido que vive dentro de nuestra sección

// 1. Defino el tipo de dato para cada "tarea" (buena práctica de TS)
interface Todo {
  id: number;
  text: string;
}
...
// Este componente es el que exporto y uso  en `page.tsx`
