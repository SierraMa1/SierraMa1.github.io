...
const navItems = [
  ...
  { name: 'Playground', href: '/#playground' }, // Nueva sección
...
export default function Header() {
  ...
  // Nota: El scroll suave funciona mejor con el ID en el body/sección que con '/#inicio'
  // Cambiado '/#inicio' por '/' para el logo principal
  const handleLinkClick = () => {
    // Cerramos el menú en móvil al hacer clic
    setIsMenuOpen(false); 
  };
  ...
  return (
    <header className={cn(
      ...
      {/* Menú desplegable para móvil (Ahora navItems) */}
      {isMenuOpen && (
