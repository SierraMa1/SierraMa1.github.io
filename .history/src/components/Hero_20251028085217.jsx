      ...
      >
        ...
        <SwiperSlide>
          <div className="flex h-full w-full flex-col items-center justify-center text-center text-white p-4 px-8 md:px-4">
            <h1 className="text-4xl md:text-6xl font-bold drop-shadow-lg">Desarrollo Full Stack con la Mentalidad Analítica de un Estratega Empresarial.  </h1>
            <p className="mt-4 text-lg md:text-xl max-w-2xl drop-shadow-md">Automatizo Procesos, No solo Web.Alineo su tecnología con la estrategia de negocio para pasar de 0 a 100.</p>
