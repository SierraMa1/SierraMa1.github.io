...
function TodoListApp() {
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-800 shadow-xl rounded-2xl p-6 w-full max-w-md mx-auto border border-gray-200 dark:border-gray-700 h-full flex flex-col transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl dark:hover:shadow-blue-500/20">
      ...
      <form onSubmit={handleSubmit} className="flex gap-3 mb-4">
        <input
          ...
          className="flex-grow p-3 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <button
          type="submit"
      ...
      <ul className="space-y-3 h-48 overflow-y-auto pr-2 flex-grow">
        {todos.length === 0 ? (
          ...
          todos.map(todo => (
            <li
              key={todo.id}
              className="flex justify-between items-center p-3 bg-white dark:bg-gray-900 rounded-lg shadow-sm animate-fade-in"
            >
...
function GithubProfileFinder() {
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-800 shadow-xl rounded-2xl p-6 w-full max-w-md mx-auto border border-gray-200 dark:border-gray-700 h-full flex flex-col transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl dark:hover:shadow-green-500/20">
      <h3 className="text-xl font-bold text-center text-gray-900 dark:text-white mb-4 flex items-center justify-center gap-2">
      ...
      <form onSubmit={handleSubmit} className="flex gap-3 mb-4">
        <input
          ...
          className="flex-grow p-3 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500" // Color de focus
        />
        <button
          type="submit"
          disabled={loading}
      ...
      <div className="flex-grow flex items-center justify-center text-center h-48">
        ...
        {profile && (
          <a href={profile.html_url} target="_blank" rel="noopener noreferrer" className="block text-left p-4 bg-white dark:bg-gray-900 rounded-lg w-full animate-fade-in">
...
\`\`\``
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-800 shadow-xl rounded-2xl p-6 w-full max-w-md mx-auto border border-gray-200 dark:border-gray-700 h-full flex flex-col transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl dark:hover:shadow-purple-500/20">
      <h3 className="text-xl font-bold text-center text-gray-900 dark:text-white mb-4 flex items-center justify-center gap-2">
      ...
      <div className="flex flex-col gap-4 flex-grow h-64 md:h-auto">
        <textarea
          ...
          className="w-full h-40 p-3 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 font-mono text-sm"
          placeholder="Escribe tu Markdown aquí..."
        />
        <div className="w-full h-48 flex-grow p-3 bg-white dark:bg-gray-900 rounded-lg overflow-y-auto prose dark:prose-invert">
