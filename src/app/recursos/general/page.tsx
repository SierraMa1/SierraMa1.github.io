...
const GOOGLE_CALENDAR_URL_GENERAL = "https://calendar.app.google/eDSdfCBi2ZSNSTfRA"; 
// ----------------------------------------------------
    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <header className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
          Roadmap 2026: Consultoría Estratégica y Desarrollo Full Stack para Desafíos Complejos.
        </h1>
