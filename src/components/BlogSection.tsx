...
const blogPosts = [
  ...
  // ¡AQUÍ ESTÁ EL NUEVO ARTÍCULO!
  {
    slug: '/blog/olvide-una-coma', 
    title: 'Horas perdidas por una coma (y otros clásicos)',
    description: 'Ese punto y coma que falta, un nombre de variable mal escrito... un post para que nos sintamos identificados.',
    tags: ['Humor', 'Debug', 'DevLife'],
  },
];
// -------------------------
